function decompress(str) {
  let [wordsSplit, words_arr] = [str.split(" "), []];

  for (let word of wordsSplit) {
    if (!isNaN(word)) words_arr.push(wordsSplit[parseInt(word) - 1]);
    else words_arr.push(word);
  }

  return words_arr.join(" ");
}

console.log(decompress("practice makes perfect and 3 1 2 3")); // "practice makes perfect and perfect practice makes perfect".
console.log(decompress("hello 1 1")); // "hello hello hello".
console.log(decompress("the cat sat on 1 mat 4 which 1 2 3")); // "the cat sat on the mat on which the cat sat".
console.log(decompress("the more you know 1 2 3 realize 3 don't 4")); // "the more you know the more you realize you don't know".
console.log(
  decompress(
