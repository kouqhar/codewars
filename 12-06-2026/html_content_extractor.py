...
print(extract_content("<p>hello world</p>")); # "hello world".
print(extract_content("<p>hello <span>world</span></p>")); # "hello world".
print(extract_content('<a href="example.com">Click me</a>')); # "Click me".
print(
  extract_content(
