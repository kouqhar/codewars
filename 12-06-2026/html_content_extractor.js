...
console.log(extractContent("<p>hello world</p>")); // "hello world".
console.log(extractContent("<p>hello <span>world</span></p>")); // "hello world".
console.log(extractContent('<a href="example.com">Click me</a>')); // "Click me".
console.log(
  extractContent(
